...
async function migrateContent() {
  try {
    console.log('🚀 Starting Complete Content Migration for Crafted Group Website')
    console.log('================================================================\n')
    ...
    console.log('2. Add testimonials in the Shared Content section')
    console.log('3. Create legal pages (Privacy Policy, Terms of Service)')
    console.log('4. Update contact information with your real details')
    console.log('5. Add your logo and images')
    console.log('6. Update the pages to fetch content from Sanity CMS')
